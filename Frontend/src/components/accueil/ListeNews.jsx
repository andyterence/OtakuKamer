    ...
    return(
        <div className='w-full h-full bg-[#1A1A2E] flex flex-col justify-center items-center pt-15 gap-10'>
            <div className='flex flex-col justify-center items-center gap-2'>
                <h1 className='md:my-10 h-full font-bold md:text-6xl text-[#F1F1F1] shadow-lg shadow-indigo-500/50'>Actualités Otaku</h1>
            ...
            <div className='md:flex flex-col justify-center items-center gap-10 my-10 rounded-xl'>
                {newsFiltres.length === 0 
                    ...
                    : newsFiltres.map(news => (
                        <div key={news.id} className='card h-90 md:h-55 md:w-250 flex flex-col md:flex-row justify-center items-center gap-1 bg-linear-to-r from-purple-900 to-black rounded-xl border-2 border-purple-500 shadow-lg shadow-indigo-500/50 font-bold transition-all duration-300 hover:scale-105 hover:opacity-80 p-4'>
            ...
            <div className='pb-15'>
                <button onClick={() => setFiltreActif('TOUT')} className='shadow-lg shadow-indigo-500/50 bg-linear-to-r from-purple-600 to-blue-500 px-10 h-14 rounded-md font-bold text-lg cursor-pointer transition-all duration-300 hover:scale-90 hover:opacity-90'>VOIR TOUTES LES NOUVEAUTES</button>
            </div>
        </div>
    )
}
